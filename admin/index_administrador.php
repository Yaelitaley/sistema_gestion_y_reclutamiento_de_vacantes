...
<?php include "includes/footer.php"; ?>
                ...
                <i class="bi bi-plus-circle-fill me-2"></i> Agregar Administrador
            </a>
        </div>

        <?php if (!$tablasOk): ?>
            <div class="alert alert-warning">Faltan tablas para esta pantalla. Importa <strong>database_chris.sql</strong> en MySQL.</div>
        <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($administradores as $admin): ?>
                            <tr>
                                ...
                                <td><?= badge_estado($admin['estado']) ?></td>
                                <td>
