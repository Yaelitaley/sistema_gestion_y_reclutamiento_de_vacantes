                ...
                <div class="row g-3">
                    <div class="col-lg-8">
                        <div class="input-group">
                            ...
                            <input type="text" name="busqueda" class="form-control" placeholder="Buscar empresa o puesto...">
                        </div>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <button type="button" class="btn btn-sm btn-outline-danger btnCancelarPostulacion"><i class="bi bi-x-circle-fill"></i></button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>Guadalajara</td>
                            <td>13/06/2026</td>
                            <td><span class="badge bg-info">Entrevista</span></td>
                            <td class="text-center">
                                <a href="ver-empleo.php" class="btn btn-sm btn-outline-primary"><i class="bi bi-eye-fill"></i></a>
                                <button type="button" class="btn btn-sm btn-outline-danger btnCancelarPostulacion"><i class="bi bi-x-circle-fill"></i></button>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>Querétaro</td>
                            <td>10/06/2026</td>
                            <td><span class="badge bg-success">Contratado</span></td>
                            <td class="text-center">
                                <a href="ver-empleo.php" class="btn btn-sm btn-outline-primary"><i class="bi bi-eye-fill"></i></a>
                                <button type="button" class="btn btn-sm btn-outline-danger btnCancelarPostulacion"><i class="bi bi-x-circle-fill"></i></button>
                            </td>
                ...
                <div class="dashboard-card">
                    ...
                    <div>
                        ...
                        <p class="mb-0 text-muted">
                            Has enviado <strong>12 postulaciones</strong>, de las cuales <strong>4</strong> continúan en revisión y <strong>3</strong> ya avanzaron a entrevista.
                        </p>
                    </div>
                </div>
            </div>
