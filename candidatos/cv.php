    ...
    <div class="content w-100 p-4">
        ...
        <div class="table-box mb-4">
            ...
            <p class="text-muted">
                ...
                Estudiante de Ingeniería en Programación y Web con conocimientos
                en HTML, CSS, Bootstrap, JavaScript, PHP y MySQL.
                Interesado en el desarrollo Frontend y la creación de interfaces
                modernas, intuitivas y responsivas.
        ...
        <div class="table-box mb-5">
            ...
            <p class="text-muted">
                ...
                Continuar desarrollándome profesionalmente dentro del área
                del desarrollo web, participando en proyectos innovadores
                donde pueda aplicar y fortalecer mis conocimientos en
                tecnologías frontend y backend, contribuyendo al crecimiento
                de la empresa y adquiriendo nuevas habilidades.
