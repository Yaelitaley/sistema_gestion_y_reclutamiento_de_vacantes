...
// Verificar que el correo existe y es candidato 
$stmt = $conn->prepare("SELECT id FROM usuarios WHERE email = ? AND rol_id = 4");
...
$enlace = "http://localhost/sistema_gestion_y_reclutamiento_de_vacantes/candidatos/reset_password.php?token=" . $token;
    ...
    $mail->Body    = '
        <div style="font-family: Poppins, sans-serif; max-width: 500px; margin: auto; padding: 30px; border-radius: 10px; border: 1px solid #ddd;">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="' . $enlace . '"
                   style="background-color: #198754; color: white; padding: 12px 30px; border-radius: 6px; text-decoration: none; font-weight: bold;">
